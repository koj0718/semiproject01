...
/**
 * Servlet implementation class ReviewWeekServlet
 */
@WebServlet("/reviewWeek.do")
public class ReviewWeekServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewWeekServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReviewManage> result=new ReviewService().searchReviewListWeek(loginId,cPage,numPerpage);
		int totalData=new ReviewService().searchReviewCountWeek(loginId);
