...
/**
 * Servlet implementation class Review3monthServlet
 */
@WebServlet("/review3Month.do")
public class Review3monthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Review3monthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReviewManage> result=new ReviewService().searchReviewList3Month(loginId,cPage,numPerpage);
		int totalData=new ReviewService().searchReviewCount3Month(loginId);
